...
import com.blog.weiblog.controller.vo.BlogListVO;
import com.blog.weiblog.controller.vo.SimpleBlogListVO;
import com.blog.weiblog.dao.*;
...
import com.blog.weiblog.service.BlogService;
import com.blog.weiblog.utils.MarkdownToHtml;
import com.blog.weiblog.utils.PageQueryUtil;
import com.blog.weiblog.utils.PageResult;
import com.blog.weiblog.utils.PatternUtil;
...
public class BlogServiceImpl implements BlogService {
    ...
    @Override
    public PageResult getBlogsPage(PageQueryUtil pageQuery) {
        List<Blog> blogList = blogMapper.getBlogList(pageQuery);
        int totalCount = blogMapper.getTotalBlogs(pageQuery);
        return new PageResult(blogList, totalCount, pageQuery.getLimit(), pageQuery.getPage());
    }
    ...
    private BlogDetailVO getBlogDetailVO(Blog blog) {
        if (blog != null && blog.getBlogStatus() == 1) {
            ...
            blogDetailVO.setBlogContent(MarkdownToHtml.markdownToHtml(blogDetailVO.getBlogContent()));
            BlogCategory blogCategory = categoryMapper.selectByPrimaryKey(blog.getBlogCategoryId());
            if (blogCategory == null) {
                blogCategory = new BlogCategory();
                blogCategory.setCategoryId(0);
