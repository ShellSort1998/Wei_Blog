...
public class BlogController {
    ...
    public Result comment(HttpServletRequest request, HttpSession session,
        ...
        String specCaptcha = (String) session.getAttribute("verifyCode");
        if (specCaptcha == null || !specCaptcha.toLowerCase().equals(verifyCode)) {
        ...
        comment.setCommentator(WeiBlogUtils.cleanString(commentator));
        comment.setEmail(email);
        if (PatternUtil.isURL(websiteUrl)) {
            comment.setWebsiteUrl(websiteUrl);
        }
        comment.setCommentBody(WeiBlogUtils.cleanString(commentBody));
