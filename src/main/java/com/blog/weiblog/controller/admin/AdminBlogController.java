...
import com.blog.weiblog.config.Constants;
...
import com.blog.weiblog.utils.WeiBlogUtils;
...
public class AdminBlogController {
    ...
    public Result list(@RequestParam Map<String, Object> params) {
        ...
        return ResultGenerator.genSuccessResult(blogService.getBlogsPage(pageQuery));
    }
    ...
    public void uploadFileByEditormd(HttpServletRequest request,
        ...
        String fileUrl = WeiBlogUtils.getHost(new URI(request.getRequestURL() + "")) + "/upload/" + newFileName;
